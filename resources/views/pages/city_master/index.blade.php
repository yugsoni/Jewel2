                  ...
                  <div class="card rounded-0 mb-0 px-2">
                      <div class="card-header pb-1">
                          <div class="card-title">
                              <h4 class="mb-0">Add a City</h4>
                          </div>
                      </div>

                      <p class="px-2">Welcome {{ Auth::user()->name }}, add a City </p>
...
{{--                             <img src="uploads/{{ Session::get('image-upload') }}"> --}}
                            ...
                            <form method="post" action="{{ route('add_city') }}">
                              ...
                              <fieldset class="form-label-group form-group position-relative has-icon-left">
                                  ...
                                  <input id="City" type="City" class="form-control" name="City" placeholder="Enter the City" required autofocus>
