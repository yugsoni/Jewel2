...
@section('title', 'Add A Speciality')
                  ...
                  <div class="card rounded-0 mb-0 px-2">
                      <div class="card-header pb-1">
                          <div class="card-title">
                              <h4 class="mb-0">Add a Speciality</h4>
                          </div>
                      </div>

                      <p class="px-2">Welcome {{ Auth::user()->name }}, add a Speciality </p>
...
{{--                             <img src="uploads/{{ Session::get('image-upload') }}"> --}}
                            ...
                            @endif
                            <br>
                            <form method="post" action="{{ route('add_Specialities') }}">
                              @csrf
                              <fieldset class="form-label-group form-group position-relative has-icon-left">

                                  <input id="Specialities" type="Specialities" class="form-control" name="Specialities" placeholder="Enter the Speciality" required autofocus>

                                  <div class="form-control-position">
                                      <i class="feather icon-edit"></i>
                                  </div>
                                  <label for="Specialities">Enter the Speciality</label>
                              </fieldset>
